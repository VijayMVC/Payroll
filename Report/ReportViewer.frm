...
'  MsgBox DateFrom
    ...
    ' crxReport.Database.SetDataSource "SERVER"
      crxReport.ParameterFields.GetItemByName("@Department").ClearCurrentValueAndRange
      crxReport.ParameterFields.GetItemByName("@Department").AddCurrentValue IDS  '<-- Variable
   ...
   '  crxReport.PrintOut True, 1
    ...
    crvPayroll.ReportSource = crxReport
    crvPayroll.ViewReport

    While crvPayroll.IsBusy
    DoEvents
    Wend
    crvPayroll.Zoom "100"
    '.Visible = False
